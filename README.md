# This is my package laravel-user-context
...
[![GitHub Code Style Action Status](https://img.shields.io/github/actions/workflow/status/syriable/laravel-user-context/fix-php-code-style-issues.yml?branch=main&label=code%20style&style=flat-square)](https://github.com/syriable/laravel-user-context/actions?query=workflow%3A"Fix+PHP+code+style+issues"+branch%3Amain)
...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-user-context.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-user-context)
...
```bash
php artisan vendor:publish --tag="laravel-user-context-views"
```

## Usage

```php
$userContext = new Syriable\UserContext();
echo $userContext->echoPhrase('Hello, Syriable!');
```
